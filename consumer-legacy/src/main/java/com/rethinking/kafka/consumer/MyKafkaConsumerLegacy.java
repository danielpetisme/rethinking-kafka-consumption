...
public class MyKafkaConsumerLegacy {

    private static final Logger LOGGER = LoggerFactory.getLogger(MyKafkaConsumerLegacy.class);
    ...
    public static void main(String[] args) {
        ...
        String groupId = getEnvOrDefault("GROUP_ID", "legacy-consumer-group");
        ...
        properties.put(ConsumerConfig.CLIENT_ID_CONFIG, "consumer-legacy");
        ...
        try (KafkaConsumer<String, String> consumer = new KafkaConsumer<>(properties)) {
            ...
            LOGGER.info("Subscribed to topic {} with group.id={} using classic group protocol.", topic,
                    groupId);
